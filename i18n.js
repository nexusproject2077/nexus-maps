...
const NexusI18n = (() => {
  ...
  const DICT = {
    fr: {
      ...
      'status.city': 'Troyes & alentours', 'status.network': 'Connexion TCAT…', 'status.live': 'TCAT en direct', 'status.partial': 'TCAT partiel', 'status.offline': 'TCAT indisponible',
      ...
      'layers.cycle': 'Pistes cyclables', 'layers.poi': "Points d'intérêt", 'layers.eco': "Mode économie d'énergie",
      'layers.filter': 'Filtrer les lignes', 'layers.all': 'Tout', 'layers.none': 'Aucune',
      'layers.disclaimer': "Clique un <strong>arrêt</strong> pour voir les prochains passages en <strong>temps réel</strong> (flux officiel TCAT). Les bus utilisent le <strong>GPS TCAT</strong> lorsqu'il est publié, sinon une estimation des horaires.",
    ...
    en: {
      ...
      'status.city': 'Troyes & nearby', 'status.network': 'Connecting to TCAT…', 'status.live': 'TCAT live', 'status.partial': 'TCAT partial', 'status.offline': 'TCAT unavailable',
      ...
      'layers.cycle': 'Cycle lanes', 'layers.poi': 'Points of interest', 'layers.eco': 'Power-saving mode',
      'layers.filter': 'Filter lines', 'layers.all': 'All', 'layers.none': 'None',
      'layers.disclaimer': 'Tap a <strong>stop</strong> to see the next departures in <strong>real time</strong> (official TCAT feed). Buses use <strong>TCAT GPS</strong> when published, otherwise a schedule estimate.',
